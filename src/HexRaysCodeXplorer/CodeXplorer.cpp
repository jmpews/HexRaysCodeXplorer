...
static const char hotkey_so[] =
    "Q"; // After positioning cursor at source code user can press Q to copy to clipboard string of form modulename + 0xoffset.
...
struct ida_local renamer_t : public ctree_visitor_t {
    ...
    renamer_t(to_raname_t &to_rename, lvars_t &lvars)
        : ctree_visitor_t(CV_FAST), to_rename_(to_rename), lvars_(lvars) {}
...
#define DECLARE_GI_VAR graph_info_t *gi = (graph_info_t *)ud
...
class MenuActionHandler : public action_handler_t {
  public:
    ...
    MenuActionHandler(handler_t handler) : handler_(handler) {}
...
static action_desc_t kActionDescs[] = {
    ACTION_DESC_LITERAL("codexplorer::display_ctree_graph", "Display Ctree Graph", &kDisplayCtreeGraphHandler,
                        hotkey_dg, nullptr, -1),
    ACTION_DESC_LITERAL("codexplorer::object_explorer", "Object Explorer", &kObjectExplorerHandler, hotkey_ce, nullptr,
                        -1),
    ACTION_DESC_LITERAL("codexplorer::reconstruct_type", "REconstruct Type", &kReconstructTypeHandler, hotkey_rt,
                        nullptr, -1),
    ACTION_DESC_LITERAL("codexplorer::extract_types_to_file", "Extract Types to File", &kExtractAllTypesHandler,
                        hotkey_et, nullptr, -1),
    ACTION_DESC_LITERAL("codexplorer::extract_ctrees_to_file", "Extract Ctrees to File", &kExtractAllCtreesHandler,
                        hotkey_ec, nullptr, -1),
    ACTION_DESC_LITERAL("codexplorer::ctree_item_view", "Ctree Item View", &kShowCurrentCItemInCustomView, hotkey_vc,
                        nullptr, -1),
    ACTION_DESC_LITERAL("codexplorer::jump_to_disasm", "Jump to Disasm", &kJumpToDisasmHandler, hotkey_gd, nullptr, -1),
    ACTION_DESC_LITERAL("codexplorer::show_copy_item_offset", "Show/Copy item offset",
                        &kShowOffsetInWindbgFormatHandler, hotkey_so, nullptr, -1),
